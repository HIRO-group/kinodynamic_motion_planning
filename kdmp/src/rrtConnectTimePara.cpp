...
int main(int argc, char** argv)
{
  ...
  ROS_ERROR("Published robot state");
  visual_tools.trigger();
  ...
  ROS_ERROR("CONSTRAINTS CONSTRUCTED");
  ...
  ROS_ERROR("CONTEXT CONSTRUCTED WITH ERROR CODE: %d", res.error_code_);
  context->solve(res);
  ROS_ERROR("SOLVED");
