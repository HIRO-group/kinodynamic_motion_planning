...
public:
    ...
    void lsoda(LSODA_ODE_SYSTEM_TYPE f, const size_t neq, vector<double> &y, double *t,
        double tout, int itask, int *istate, int iopt, int jt, array<int, 7> &iworks,
        array<double, 4> &rworks, void *_data);
    ...
    void lsoda_update(LSODA_ODE_SYSTEM_TYPE f, const size_t neq, vector<double> &y,
